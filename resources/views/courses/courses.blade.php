                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                            ...
                            <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                               data-toggle="modal" href="#modaldemo8">اضافة دورة</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                               ...
                                               data-techer_name="{{ $course ->techer_name }}"
                    ...
                    <div class="modal-body">
                        <form action="{{ route('courses.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="techer_name" name="techer_name">
                            </div>
...
@section('js')
    ...
    <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var techer_name = button.data('techer_name')
            ...
            modal.find('.modal-body #techer_name').val(techer_name);
